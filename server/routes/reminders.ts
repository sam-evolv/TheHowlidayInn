...
remindersRouter.post('/api/reminders/check', requireOwnerAuth, async (req: any, res) => {
  try {
...
remindersRouter.post('/api/reminders/send/:bookingId', requireOwnerAuth, async (req: any, res) => {
  try {
...
remindersRouter.get('/api/reminders/settings', requireOwnerAuth, async (req: any, res) => {
  try {
...
remindersRouter.put('/api/reminders/settings', requireOwnerAuth, async (req: any, res) => {
  try {

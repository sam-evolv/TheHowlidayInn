...
// List with filters
adminDogsRouter.get("/api/admin/dogs", requireOwnerAuth, async (req, res) => {
    try {
...
// Detail
adminDogsRouter.get("/api/admin/dogs/:id", requireOwnerAuth, async (req, res) => {
    const { id } = req.params;
...
// Approve or reject
adminDogsRouter.patch("/api/admin/dogs/:id/status", requireOwnerAuth, async (req, res) => {
    const { id } = req.params;
...
// Daily vaccine scan
adminDogsRouter.post("/api/admin/tasks/daily-vaccine-scan", async (req, res) => {
